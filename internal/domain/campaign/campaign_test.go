...
func Test_NewCampaign_CreateCampaign(t *testing.T) {
	...
	campaign, _ := NewCampaignRequest(name, content, contacts, createdBy)
...
func Test_NewCampaign_MustValidateNameMin(t *testing.T) {
	...
	_, error := NewCampaignRequest("", content, contacts, createdBy)
...
func Test_NewCampaign_MustValidateNameMax(t *testing.T) {
	...
	_, error := NewCampaignRequest(fake.Lorem().Text(30), content, contacts, createdBy)
...
func Test_NewCampaign_MustValidateContentMin(t *testing.T) {
	...
	_, error := NewCampaignRequest(name, "", contacts, createdBy)
...
func Test_NewCampaign_MustValidateContentMax(t *testing.T) {
	...
	_, error := NewCampaignRequest(name, fake.Lorem().Text(1200), contacts, createdBy)
...
func Test_NewCampaign_MustValidateContactsMin(t *testing.T) {
	...
	_, error := NewCampaignRequest(name, content, []string{}, createdBy)
...
func Test_NewCampaign_MustValidateContacts(t *testing.T) {
	...
	_, error := NewCampaignRequest(name, content, []string{"email invalid"}, createdBy)
...
func Test_NewCampaign_should_return_an_error_if_createdby_is_not_a_email(t *testing.T) {
	...
	_, err := NewCampaignRequest(name, content, contacts, invalidEmail)
